...
public class DemoAccountInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inventoryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DemoMenuActivity.setInventoryClickedFromInfo(true);
                Intent intent = new Intent(DemoAccountInfoActivity.this, DemoExpandWishToLendActivity.class);
        ...
        wishListButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DemoMenuActivity.setWishLIstClickedFromInfo(true);
                Intent intent = new Intent(DemoAccountInfoActivity.this, DemoExpandWishToLendActivity.class);
                startActivity(intent);
                finish();
            }
        ...
        willingToLendButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DemoMenuActivity.setWillingToLendClickedFromInfo(true);
                Intent intent = new Intent(DemoAccountInfoActivity.this, DemoExpandWishToLendActivity.class);
                startActivity(intent);
                finish();
            }
        ...
        reInfoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DemoAccountInfoActivity.this, DemoMenuActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        unfreezeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(DemoAccountInfoActivity.this, "This is a demo. " +
        ...
        public void showPopUp (View view){
            ...
            // set account status
            String accountStatus = "Account Status: Demo";
            String tradingStatus = "Trading Status: Demo";
